...
@EventBusSubscriber(modid = Limbs.MOD_ID)
public class BodyPartRegistry {
	public static final ResourceKey<Registry<BodyPartType>> BODY_PARTS_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(Limbs.MOD_ID, "body_parts"));
